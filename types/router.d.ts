...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(app)/(tabs)/chats` | `/chats` | `/(app)/(tabs)/groups` | `/groups` | `/(app)/(tabs)/happening` | `/happening` | `/(app)/(tabs)/profile` | `/profile` | `/(app)/(tabs)/settings` | `/settings` | `/(app)/theme` | `/theme` | `/(auth)/` | `/(auth)` | `/(auth)/signup` | `/signup`;
  // prettier-ignore
  type DynamicRoutes<T extends string> = `/(app)/call/${SingleRoutePart<T>}` | `/call/${SingleRoutePart<T>}` | `/(app)/chat/${SingleRoutePart<T>}` | `/chat/${SingleRoutePart<T>}` | `/(app)/profile/${SingleRoutePart<T>}` | `/profile/${SingleRoutePart<T>}` | `/(app)/story/${SingleRoutePart<T>}` | `/story/${SingleRoutePart<T>}`;
  // prettier-ignore
  type DynamicRouteTemplate = `/(app)/call/[id]` | `/(app)/chat/[id]` | `/(app)/profile/[id]` | `/(app)/story/[id]`;
